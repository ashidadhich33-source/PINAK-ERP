# backend/app/models/sales/sales_return_integration.py
...
class SaleReturnStatus(str, enum.Enum):
    """Sales return status enumeration"""
    DRAFT = "draft"
...
class SaleReturnAccounting(BaseModel):
    """Sales return accounting integration"""
    __tablename__ = "sale_return_accounting"
    ...
    def __repr__(self):
        return f"<SaleReturnAccounting(return_id={self.return_id}, amount={self.amount})>"

class SaleReturnPayment(BaseModel):
    """Sales return payment processing"""
    __tablename__ = "sale_return_payment"
    ...
    def __repr__(self):
        return f"<SaleReturnPayment(return_id={self.return_id}, amount={self.payment_amount})>"

class SaleReturnAnalytic(BaseModel):
    """Sales return analytic accounting"""
    __tablename__ = "sale_return_analytic"
    ...
    def __repr__(self):
        return f"<SaleReturnAnalytic(return_id={self.return_id}, amount={self.amount})>"

# Phase 2: Indian Localization Models
class SaleReturnGST(BaseModel):
    """Sales return GST integration"""
    __tablename__ = "sale_return_gst"
    ...
    def __repr__(self):
        return f"<SaleReturnGST(return_id={self.return_id}, gst_amount={self.total_gst_amount})>"

class SaleReturnEInvoice(BaseModel):
    """Sales return E-invoice integration"""
    __tablename__ = "sale_return_einvoice"
    ...
    def __repr__(self):
        return f"<SaleReturnEInvoice(return_id={self.return_id}, irn='{self.irn}')>"

class SaleReturnEWaybill(BaseModel):
    """Sales return E-waybill integration"""
    __tablename__ = "sale_return_ewaybill"
    ...
    def __repr__(self):
        return f"<SaleReturnEWaybill(return_id={self.return_id}, eway_no='{self.eway_bill_no}')>"

class SaleReturnTDS(BaseModel):
    """Sales return TDS integration"""
    __tablename__ = "sale_return_tds"
    ...
    def __repr__(self):
        return f"<SaleReturnTDS(return_id={self.return_id}, tds_amount={self.tds_amount})>"

class SaleReturnTCS(BaseModel):
    """Sales return TCS integration"""
    __tablename__ = "sale_return_tcs"
    ...
    def __repr__(self):
        return f"<SaleReturnTCS(return_id={self.return_id}, tcs_amount={self.tcs_amount})>"

# Phase 3: Advanced Features Models
class SaleReturnWorkflow(BaseModel):
    """Sales return workflow management"""
    __tablename__ = "sale_return_workflow"
    ...
    def __repr__(self):
        return f"<SaleReturnWorkflow(return_id={self.return_id}, step='{self.workflow_step}')>"

class SaleReturnDocument(BaseModel):
    """Sales return document management"""
    __tablename__ = "sale_return_document"
    ...
    def __repr__(self):
        return f"<SaleReturnDocument(return_id={self.return_id}, type='{self.document_type}')>"

class SaleReturnAudit(BaseModel):
    """Sales return audit trail"""
    __tablename__ = "sale_return_audit"
    ...
    def __repr__(self):
        return f"<SaleReturnAudit(return_id={self.return_id}, action='{self.action_type}')>"

class SaleReturnNotification(BaseModel):
    """Sales return notification management"""
    __tablename__ = "sale_return_notification"
    ...
    def __repr__(self):
        return f"<SaleReturnNotification(return_id={self.return_id}, type='{self.notification_type}')>"

# Phase 4: Enhanced Integration Models
class SaleReturnInventory(BaseModel):
    """Sales return inventory integration"""
    __tablename__ = "sale_return_inventory"
    ...
    adjustment_type = Column(String(20), default='increase')  # increase, decrease
    ...
    def __repr__(self):
        return f"<SaleReturnInventory(return_id={self.return_id}, item_id={self.item_id})>"

class SaleReturnCustomer(BaseModel):
    """Sales return customer integration"""
    __tablename__ = "sale_return_customer"
    ...
    def __repr__(self):
        return f"<SaleReturnCustomer(return_id={self.return_id}, customer_id={self.customer_id})>"

class SaleReturnPerformance(BaseModel):
    """Sales return performance optimization"""
    __tablename__ = "sale_return_performance"
    ...
    def __repr__(self):
        return f"<SaleReturnPerformance(return_id={self.return_id}, score={self.performance_score})>"

class SaleReturnUserExperience(BaseModel):
    """Sales return user experience tracking"""
    __tablename__ = "sale_return_user_experience"
    ...
    def __repr__(self):
        return f"<SaleReturnUserExperience(return_id={self.return_id}, user_id={self.user_id})>"

class SaleReturnSync(BaseModel):
    """Sales return real-time synchronization"""
    __tablename__ = "sale_return_sync"
    
    return_id = Column(Integer, ForeignKey('sale_return.id'), nullable=False)
    sync_type = Column(String(50), nullable=False)  # inventory, accounting, customer, analytics
    ...
    def __repr__(self):
        return f"<SaleReturnSync(return_id={self.return_id}, type='{self.sync_type}')>"

class SaleReturnAnalytics(BaseModel):
    """Sales return analytics integration"""
    __tablename__ = "sale_return_analytics"
    ...
    def __repr__(self):
        return f"<SaleReturnAnalytics(return_id={self.return_id}, provider='{self.analytics_provider}')>"