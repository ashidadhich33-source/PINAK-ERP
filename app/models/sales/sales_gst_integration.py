# backend/app/models/sales/sales_gst_integration.py
...
class SaleGST(BaseModel):
    """Link Sales to GST Tax Structure"""
    __tablename__ = "sale_gst"
    ...
    def __repr__(self):
        return f"<SaleGST(sale_id={self.sale_invoice_id}, gst_amount={self.total_gst_amount})>"

class SaleEInvoice(BaseModel):
    """Link Sales to E-invoicing"""
    __tablename__ = "sale_e_invoice"
    ...
    def __repr__(self):
        return f"<SaleEInvoice(sale_id={self.sale_invoice_id}, irn='{self.irn}')>"

class SaleEWaybill(BaseModel):
    """Link Sales to E-waybill"""
    __tablename__ = "sale_e_waybill"
    ...
    def __repr__(self):
        return f"<SaleEWaybill(sale_id={self.sale_invoice_id}, eway_no='{self.eway_bill_no}')>"

class SaleTDS(BaseModel):
    """Link Sales to TDS"""
    __tablename__ = "sale_tds"
    ...
    def __repr__(self):
        return f"<SaleTDS(sale_id={self.sale_invoice_id}, tds_amount={self.tds_amount})>"

class SaleTCS(BaseModel):
    """Link Sales to TCS"""
    __tablename__ = "sale_tcs"
    ...
    def __repr__(self):
        return f"<SaleTCS(sale_id={self.sale_invoice_id}, tcs_amount={self.tcs_amount})>"

class SaleIndianBanking(BaseModel):
    """Link Sales to Indian Banking"""
    __tablename__ = "sale_indian_banking"
    ...
    def __repr__(self):
        return f"<SaleIndianBanking(sale_id={self.sale_invoice_id}, method='{self.payment_method_type}')>"

class SaleIndianGeography(BaseModel):
    """Link Sales to Indian Geography"""
    __tablename__ = "sale_indian_geography"
    ...
    def __repr__(self):
        return f"<SaleIndianGeography(sale_id={self.sale_invoice_id}, distance={self.distance_km}km)>"