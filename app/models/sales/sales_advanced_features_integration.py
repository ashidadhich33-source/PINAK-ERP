# backend/app/models/sales/sales_advanced_features_integration.py
...
class SaleAdvancedWorkflow(BaseModel):
    """Link Sales to Advanced Workflows"""
    __tablename__ = "sale_advanced_workflow"
    ...
    def __repr__(self):
        return f"<SaleAdvancedWorkflow(sale_id={self.sale_invoice_id}, type='{self.workflow_type}')>"

class SaleDocumentManagement(BaseModel):
    """Link Sales to Document Management"""
    __tablename__ = "sale_document_management"
    ...
    def __repr__(self):
        return f"<SaleDocumentManagement(sale_id={self.sale_invoice_id}, type='{self.document_type}')>"

class SaleAdvancedReporting(BaseModel):
    """Link Sales to Advanced Reporting"""
    __tablename__ = "sale_advanced_reporting"
    ...
    def __repr__(self):
        return f"<SaleAdvancedReporting(sale_id={self.sale_invoice_id}, type='{self.report_type}')>"

class SaleAuditTrailAdvanced(BaseModel):
    """Link Sales to Advanced Audit Trails"""
    __tablename__ = "sale_audit_trail_advanced"
    ...
    def __repr__(self):
        return f"<SaleAuditTrailAdvanced(sale_id={self.sale_invoice_id}, action='{self.action_type}')>"

class SaleNotification(BaseModel):
    """Link Sales to Notifications"""
    __tablename__ = "sale_notification"
    ...
    def __repr__(self):
        return f"<SaleNotification(sale_id={self.sale_invoice_id}, type='{self.notification_type}')>"

class SaleDashboard(BaseModel):
    """Link Sales to Dashboard Widgets"""
    __tablename__ = "sale_dashboard"
    ...
    def __repr__(self):
        return f"<SaleDashboard(sale_id={self.sale_invoice_id}, widget='{self.widget_title}')>"