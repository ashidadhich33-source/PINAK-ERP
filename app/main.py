...
from .api.endpoints import (
    ...
    settings as settings_api, payments, companies, gst, financial_year, chart_of_accounts, advanced_inventory, enhanced_item_master, enhanced_purchase, enhanced_sales, double_entry_accounting, discount_management
)
